...
let book1:Book = {title: 'Гаррі Поттер', pageCount: 660, genre: 'фентезі'}
let book2:Book  = {title: 'Шерлок Холмс', pageCount: 660, genre: 'детектив'}
let book3:Book  = {title: 'Голодні ігри', pageCount: 660, genre: 'антиутопія'}
...
let book4:Book = {title: 'Гаррі Поттер', pageCount: 660, genre: 'фентезі', authors: [{Name: 'Джоан Роулінг', age: 60}]}
let book5:Book = {title: 'Шерлок Холмс', pageCount: 660, genre: 'детектив', authors: [{Name: ' Артур Конан Дойл', age: 71}]}
let book6:Book = {title: 'Голодні ігри', pageCount: 660, genre: 'антиутопія', authors: [{Name: ' Сюзанна Коллінз', age: 63}]}
...
// термін в 7 днів. Як зробити цей масив – вам потрібно подумати. Нормальних варіантів опису –
// 2. Варіант, коли в вас буде одновимірний масив з 21 значенням виключаємо одразу
type Weather = {
    day:number,
    morning:number,
    afternoon:number,
...
let x:string|null = prompt('Введіть значення х (1,0,-3)');
if (x === '0') {
    console.log('Вірно')
} else {
    console.log('Невірно')
...
let input: string | null = prompt('Введіть значення часу');
let time: number = Number(input);
...
let inputDay: string | null = prompt('веедіть значення часу');
let day: number = Number(inputDay);
if (day >= 1 && day <= 10) {
    console.log('в першу')
...
let dayNumber:number = Number(prompt('Enter day number'));
